...
'----- Prioriteiten Referentie --------------
' Gelijk aan de ID's in tabel : Prioriteiten
'--------------------------------------------
Const lbPrioriteitPaniek 		= 1
Const lbPrioriteitDemo 			= 2
Const lbPrioriteitNormaal 		= 3
Const lbPrioriteitGewenst 		= 4
Const lbPrioriteitIdee 			= 5

Const lbStatusNieuw     				= 1                                        	
Const lbStatusBekend            		= 2                              	
Const lbStatusInbehandeling           	= 3                       	
Const lbStatusOpgelostTest               = 4                       	
Const lbStatusTestIncident             = 5                       	
Const lbStatusOpgelost                  = 6                       	

Const lSales 				= 1
Const lbSoftwareEngineer 	= 2
Const lbExtern				= 3
Const lbEndUser				= 4
